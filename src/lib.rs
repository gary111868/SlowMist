...
#[derive(Debug)]
pub struct SlowMistSecProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SlowMistSecProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SlowMistSec processing");
    
    let mut processor = SlowMistSecProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SlowMistSecProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SlowMistSecProcessor::new(false);
